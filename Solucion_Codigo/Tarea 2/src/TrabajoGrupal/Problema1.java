...
// Importamos las clases necesarias para manejar listas y entradas por consola
...
public class Problema1 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Personaje> listaPersonajes = new ArrayList<>(); // Creamos una lista para almacenar los personajes

        // Imprimimos el menú de inicio del juego
        System.out.println("-------------------------------------------------------");
        System.out.println("                     MENU DE INICIO                    ");
        System.out.println("             BIENVENIDO A DUELO DE HEROES            ");
        System.out.println("                           -                           ");
        ...
        int c = 0; // Variable para contar las vueltas del bucle
        while (c < 2) {
            System.out.print("Ingrese su opción: ");
            int inicio = scanner.nextInt(); // Leemos la opción seleccionada por el usuario
            switch (inicio) {
                case 1:
                    // Caso de creación de personaje
                    System.out.println("-----------------------------------------------");
                    ...
                    int opcion = scanner.nextInt(); // Leemos el tipo de personaje seleccionado
                    switch (opcion) {
                        case 1:
                            // Caso del Guerrero
                            System.out.println("-------------------------------------------------");
                            System.out.print("INGRESE LA FUERZA DEL GUERRERO (ENTRE 0 Y 100): ");
                            int fuerza = scanner.nextInt(); // Leemos la fuerza del Guerrero
                            ArrayList<String> habilidadesCuerpoList = new ArrayList<>(); // Lista para habilidades cuerpo a cuerpo
                            System.out.println("-------------------------------------------------");
                            ...
                            int habilidadesSeleccionadas = 0; // Contador de habilidades seleccionadas
                            while (habilidadesSeleccionadas < 3) {
                                System.out.print("INGRESE LA OPCIÓN DE HABILIDAD (0 PARA TERMINAR): ");
                                int habilidadOpcion = scanner.nextInt(); // Leemos la opción de habilidad
                                if (habilidadOpcion == 0) {
                                    // Si el usuario elige terminar, verificamos que haya seleccionado al menos una habilidad
                                    ...
                                    // Agregamos la habilidad seleccionada a la lista
                            ...
                            // Creamos un objeto Guerrero y lo agregamos a la lista de personajes
                        ...
                        case 2:
                            ...
                            double precision = scanner.nextDouble(); // Leemos la precisión del Arquero
                            ArrayList<String> habilidadesDistanciaList = new ArrayList<>(); // Lista para habilidades de distancia
                            System.out.println("------------------------------------------------------------------");
                            ...
                            int seleccion = 0; // Contador de habilidades seleccionadas
                            while (seleccion < 3) {
                                System.out.print("INGRESE LA OPCIÓN DE HABILIDAD (0 PARA TERMINAR): ");
                                int habilidadOpcion = scanner.nextInt(); // Leemos la opción de habilidad
                                if (habilidadOpcion == 0) {
                            ...
                            // Creamos un objeto Arquero y lo agregamos a la lista de personajes
                        ...
                        case 3:
                            ...
                            int poderMagico = scanner.nextInt(); // Leemos el poder mágico del Mago
                            System.out.println("----------------------------------------------------");
                            ...
                            int tipoMago = scanner.nextInt(); // Leemos el tipo de Mago seleccionado

                            // Validamos que el poder mágico esté dentro del rango permitido
                            ...
                            ArrayList<String> hechizosList = new ArrayList<>(); // Lista para los hechizos del Mago

                            // Agregamos hechizos a la lista según el tipo de Mago seleccionado
                            switch (tipoMago) {
                            ...
                            // Creamos un objeto Mago y lo agregamos a la lista de personajes
                    ...
                    // Mostramos los personajes creados
                    System.out.println("\nPERSONAJES CREADOS:");
                    ...
                    // Si hay al menos dos personajes, iniciamos una pelea entre ellos
                    if (listaPersonajes.size() >= 2) {
                        Personaje personaje1 = listaPersonajes.get(0);
                        Personaje personaje2 = listaPersonajes.get(1);

                        int danoPersonaje1 = personaje1.ataque(); // Calculamos el daño del primer personaje
                        int danoPersonaje2 = personaje2.ataque(); // Calculamos el daño del segundo personaje

                        // Determinamos el ganador basado en el daño
...
// Clase abstracta Personaje, base para todos los personajes del juego
abstract class Personaje {

    protected double puntoVida; // Puntos de vida del personaje
    protected int nivelExpe; // Nivel de experiencia del personaje
    ...
    public abstract void defensa(); // Método abstracto para la defensa, implementado en subclases

    public abstract int ataque(); // Método abstracto para el ataque, implementado en subclases
}

// Subclase Guerrero que extiende de Personaje
class Guerrero extends Personaje {

    private int fuerza; // Fuerza del Guerrero
    private ArrayList<String> habilidadesCuerpo; // Lista de habilidades cuerpo a cuerpo
    ...
    public void defensa() {
        // Implementación vacía para la defensa del Guerrero
    }

    @Override
    public int ataque() {
        // Calculamos el daño promedio de las habilidades del Guerrero
        int danoPromedio = 0;
    ...
    public int getDano(String habilidad) {
        int danoBase = 0;
        // Asignamos el daño base según la habilidad
        switch (habilidad) {
            case "Punietazo":
                danoBase = 10;
                break;
            ...
            case "Cabezazo":
                ...
                break;
            default:
                // Opción incorrecta, no se hace nada
        }
        return danoBase + fuerza; // Sumamos la fuerza del Guerrero al daño base
    }
}

// Subclase Mago que extiende de Personaje
class Mago extends Personaje {

    private ArrayList<String> hechizos; // Lista de hechizos del Mago
    private int poderMagico; // Poder mágico del Mago
    ...
    public void defensa() {
        // Implementación vacía para la defensa del Mago
    }

    @Override
    public int ataque() {
        // Calculamos el daño promedio de los hechizos del Mago
        int danoPromedio = 0;
    ...
    public int getDano(String hechizo) {
        int danoBase = 0;
        // Asignamos el daño base según el hechizo
        switch (hechizo) {
            case "Escarcha":
                danoBase = 15;
                break;
        ...
        return danoBase + poderMagico; // Sumamos el poder mágico del Mago al daño base
    }
}

// Subclase Arquero que extiende de Personaje
class Arquero extends Personaje {

    private double precision; // Precisión del Arquero
    private ArrayList<String> habilidadesDistancia; // Lista de habilidades de distancia
    ...
    public void defensa() {
        // Implementación vacía para la defensa del Arquero
    }

    @Override
    public int ataque() {
        // Calculamos el daño promedio de las habilidades del Arquero
        int danoPromedio = 0;
    ...
    public int getDano(String habilidad) {
        ...
        return (int) (danoBase * (precision / 100.0)); // Multiplicamos el daño base por la precisión
    }
}
